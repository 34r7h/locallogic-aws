...
function geodir_event_display_calendar(){
	...
	<tr>
	<?php if($day!='1'){ ?><td align="center" class="days"  ><strong><?php echo apply_filters('geodir_event_cal_single_day_sunday',__('S', GEODIREVENTS_TEXTDOMAIN));?></strong></td><?php } ?>
	<td class="days"  ><strong><?php echo apply_filters('geodir_event_cal_single_day_monday',__('M', GEODIREVENTS_TEXTDOMAIN));?></strong></td>
	<td class="days" ><strong><?php echo apply_filters('geodir_event_cal_single_day_tuesday',__('T', GEODIREVENTS_TEXTDOMAIN));?></strong></td>
	<td class="days" ><strong><?php echo apply_filters('geodir_event_cal_single_day_wednesday',__('W', GEODIREVENTS_TEXTDOMAIN));?></strong></td>
	<td class="days" ><strong><?php echo apply_filters('geodir_event_cal_single_day_thursday',__('T', GEODIREVENTS_TEXTDOMAIN));?></strong></td>
	<td class="days" ><strong><?php echo apply_filters('geodir_event_cal_single_day_friday',__('F', GEODIREVENTS_TEXTDOMAIN));?></strong></td>
	<td class="days" ><strong><?php echo apply_filters('geodir_event_cal_single_day_saturday',__('S', GEODIREVENTS_TEXTDOMAIN));?></strong></td>
    <?php if($day=='1'){ ?><td class="days" ><strong><?php echo apply_filters('geodir_event_cal_single_day_sunday',__('S', GEODIREVENTS_TEXTDOMAIN));?></strong></td><?php } ?>
	</tr> 
	<?php
	...
	for ($i=0; $i<($maxday+$startday); $i++) {
		...
		else 
		{
			...
			if(in_array($event_date, $all_event_dates)){
				...
				echo "<a class=\"event_highlight\" href=\"$thelink\" title=\"".__('Click to view events on this date', GEODIREVENTS_TEXTDOMAIN)."\" >". ($cal_date) . "</a>";
