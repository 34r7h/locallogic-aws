...
(function($) {
    $(document).ready(function () { 
	   ...
	   $('.uultra-tooltip').qtip();
		...
		//this will display the message box to contact the admin
		$(document).on("click", "#uultra-confirm-image-cropping", function(e) {
			...
			jQuery.ajax({
				type: 'POST',
				url: ajaxurl,
				data: {"action": "uultra_crop_bg_user_profile_image", "x1": x1 , "y1": y1 , "x2": x2 , "y2": y2 , "w": w , "h": h  , "image_id": image_id},
