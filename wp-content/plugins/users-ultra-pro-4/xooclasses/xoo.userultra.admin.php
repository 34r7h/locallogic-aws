  ...
  <div class="user-ultra-success uultra-notification" id="uultra-sucess-fields-<?php echo $pos; ?>"><?php _e('Success ','xoousers'); ?></div>
	...
	public function get_special_checks($tab) 
	{
		...
		if($tab=="settings")
		{
		 ...
		 $special_with_check = array('hide_admin_bar', 'disable_default_lightbox', 'private_message_system','redirect_backend_profile','redirect_backend_registration','redirect_backend_login', 'social_media_fb_active', 'social_media_linked_active', 'social_media_yahoo', 'social_media_google', 'twitter_connect', 'yammer_connect', 'twitter_autopost','mailchimp_active', 'mailchimp_auto_checked', 'media_allow_photo_uploading', 'membership_display_selected_only');
