...
?>
				...
				<div id="plupload-upload-ui-profilebg" class="hide-if-no-js">
					...
					<div id="drag-drop-area-profilebg">
                        ...
                        <div  class="uultra-bg-image-box" id="uultra-bg-img-bg-id"><?php echo $this->get_profile_bg($user_id )?></div>
                            ...
                            <p class="drag-drop-info"><?php	_e('1250 X 550 pixel size recommended', 'xoousers') ; ?></p>
                            <div style="display:">
	...
	function uultra_display_bg_image_to_crop($image)	
	 {
		...
		/* Custom style */		
		wp_register_style( 'uuultra_image_cropper_style', xoousers_url.'js/imagcropper/style/imgareaselect-default.css');
		wp_enqueue_style('uuultra_image_cropper_style');				
		wp_enqueue_script('simple_cropper',  xoousers_url.'js/imagcropper/jquery.imgareaselect.min.js' , null, false, true);
		...
		?>
        		...
        		<div id="uultra-dialog-user-bg-cropper" style="margin-top: 10px;" >
			...
			<div id="uploaderSection" style="position: relative;">
				<div id="plupload-upload-ui-profilebg" class="hide-if-no-js">
					...
					<div id="drag-drop-area-profilebg">
                        ...
                        <div  class="uultra-bg-image-box" id="uultra-bg-img-bg-id"><?php echo $html_image ?></div>
                        
                        <p class="drag-drop-buttons"><input id="uultra-confirm-image-cropping" type="button" value="<?php _e('CROP AND SAVE', 'xoousers'); ?>" class="button"  /></p>
                ...
                <input type="hidden" name="site_redir" value="<?php echo $site_url."myaccount/?module=profile-customizer"?>" id="site_redir" />
		...
		<script type="text/javascript">
				...
				jQuery(document).ready(function($){
					...
					//  $minWidth = $r_width; //test
					 //$minHeight = $minHeight; //test
					 $aspect_ratio = '1:1';
					 
					 $diff = 0;
					 $x2_widht_plus_diff = $minWidth;
					 $height = $minHeight;
					...
					// var height = ( this.width / 16 ) * 9;					 
					 ...
					 var uultr_cropper = jQuery('#uultra-profile-cover-horizontal').imgAreaSelect({ 
						...
						imageWidth: <?php echo $r_width?>, 
						imageHeight: <?php echo $r_height?> 
	...
	function uultra_crop_bg_user_profile_image()
	{
		...
		$xoouserultra->imagecrop->renderImage($src);
		...
		if ( $user_pic!="" )
		{
			 ...
			 if(file_exists($path_avatar))
			 {
			  ...
			  //update meta
			  update_user_meta($user_id, 'user_profile_bg', $image_id);		  
